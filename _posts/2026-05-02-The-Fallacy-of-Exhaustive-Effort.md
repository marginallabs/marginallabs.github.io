...
![The second-best optimum  may require violating the remaining conditions]({{ site.baseurl }}/assets/img/posts/2026-05-02/fig_conditions.png){:.figure-img}
...
![Monopoly restricts output; pollution expands it]({{ site.baseurl }}/assets/img/posts/2026-05-02/fig_monopoly.png){:.figure-img}
...
![The fallacy flips the reasoning direction]({{ site.baseurl }}/assets/img/posts/2026-05-02/fig_fallacy.png){:.figure-img}
